...
public class MedicineController {
	...
	public ResponseEntity<Medicine> getPatientById(@PathVariable Long id) throws AttributeNotFoundException{
		...
		Medicine medicine=medicineRepository.findById(id).orElseThrow(()->new AttributeNotFoundException("ABCD"+id));
	...
	public ResponseEntity<Map<String,Boolean>> deleteMachine(@PathVariable Long id) throws AttributeNotFoundException{
