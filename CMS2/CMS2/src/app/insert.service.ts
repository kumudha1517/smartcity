...
export class InsertService {
  ...
  url5="http://localhost:8070/insertadmin"
  url6="http://localhost:8070/loginadmin"
  url7="http://localhost:8070/viewadmin"

  url1="http://localhost:8070/addstudent"
  url2="http://localhost:8070/loginstudent"
  url3="http://localhost:8070/viewstudent"
  url11="http://localhost:8070/updatestudent"
  url12="http://localhost:8070/deletestudent"


  url20="http://localhost:8070/addcestudent"
  url21="http://localhost:8070/logincestudent"
  url22="http://localhost:8070/viewcestudent"
  url23="http://localhost:8070/updatecestudent"
  url24="http://localhost:8070/deletecestudent"

 

  url30="http://localhost:8070/addcefaculty"
  url31="http://localhost:8070/logincefaculty"
  url32="http://localhost:8070/viewcefaculty"
  url33="http://localhost:8070/updatecefaculty"
  url34="http://localhost:8070/deletecefaculty"

  url35="http://localhost:8070/addstaff"
  url36="http://localhost:8070/loginstaff"
  url37="http://localhost:8070/viewstaff"
  url38="http://localhost:8070/updatestaff"
  url39="http://localhost:8070/deletestaff"




  url43="http://localhost:8070/addnotify"
  url44="http://localhost:8070/viewnotify"
  url45="http://localhost:8070/deletenotify"



  url50="http://localhost:8070/addfees"
  url51="http://localhost:8070/viewfees"
